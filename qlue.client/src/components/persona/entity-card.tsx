...
export const EntityCard = ({
  ...
  if (!entity || !entity.properties) {
    ...
    return (
      <Card
        className={`w-full min-w-[200px] max-w-[250px] border border-gray-100 ${className}`}
      >
  ...
  return (
    <Card
      className={`w-full min-w-[200px] max-w-[250px] hover:scale-105 transition-transform duration-200 cursor-pointer border border-gray-100 ${className}`}
    >
